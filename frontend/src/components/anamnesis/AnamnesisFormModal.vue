          ...
          <div class="relative w-full max-w-4xl bg-white dark:bg-gray-800 rounded-xl shadow-2xl" @click.stop>
            ...
            <div class="px-6 py-4 max-h-[70vh] overflow-y-auto">
              ...
              <form @submit.prevent="save" class="space-y-6">
                ...
                <div v-if="!isEditMode">
                  ...
                  <p v-if="selectedTemplate" class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <div v-if="questions.length > 0" class="space-y-6">
                  <h4 class="text-lg font-semibold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-2">Fragen</h4>
                  ...
                  <div v-for="(question, index) in questions" :key="question.id" class="space-y-2">
                    ...
                    <p v-if="question.helpText" class="text-sm text-gray-500 dark:text-gray-400">
                      {{ question.helpText }}
                    </p>
                ...
                <div v-else-if="form.templateId" class="text-center py-8 text-gray-500 dark:text-gray-400">
            ...
            <div class="sticky bottom-0 bg-gray-50 dark:bg-gray-700 px-6 py-4 rounded-b-xl border-t border-gray-200 dark:border-gray-700">
              <div class="flex justify-end space-x-3">
                <button type="button" @click="close" class="btn bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600">
                  Abbrechen
                </button>
