    ...
    <form v-else @submit.prevent="saveSettings" class="space-y-8">
      ...
      <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
        <div class="bg-gray-50 dark:bg-gray-700 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Stammdaten</h2>
        </div>
        <div class="p-6 space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <!-- Company Street -->
            <div>
              <label for="company_street" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                Straße
              </label>
              <input
                id="company_street"
            ...
            <!-- Company Country -->
            <div>
              <label for="company_country" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                Land
              </label>
              <input
                id="company_country"
            ...
            <!-- Company Tax ID -->
            <div>
              <label for="company_tax_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                Steuernummer
              </label>
              <input
                id="company_tax_id"
            ...
            <div>
              <label for="company_registration_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
          ...
          <div class="flex items-start">
            ...
            <div class="ml-3 text-sm">
              <label for="company_small_business" class="font-medium text-gray-700 dark:text-gray-300">
          ...
          <div>
            ...
            <div class="flex items-center space-x-4">
              ...
              <input
                ...
                class="block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100"
              />
            </div>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">PNG, JPG oder SVG bis 2MB</p>
          </div>
          ...
          <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">PNG oder ICO bis 512KB</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
        <div class="bg-gray-50 dark:bg-gray-700 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">E-Mail-Konfiguration</h2>
        </div>
        <div class="p-6 space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Email From Address -->
            ...
            <!-- Email Driver -->
            <div>
              <label for="email_driver" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                E-Mail Treiber
              </label>
              <select
                id="email_driver"
          ...
          <div v-if="formData.email_driver === 'smtp'" class="border-t border-gray-200 dark:border-gray-700 pt-6">
            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">SMTP Einstellungen</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <!-- SMTP Host -->
              <div>
      ...
      >
        <p class="text-red-800 dark:text-red-400">{{ saveError }}</p>
      </div>
    </form>
