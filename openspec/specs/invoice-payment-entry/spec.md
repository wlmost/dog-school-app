...
Definiert die Erfassung von Zahlungseingängen für Rechnungen über eine
Eingabemaske mit Unterstützung für Teilzahlungen, inklusive
Berechtigungen, Statusbeschränkungen und Überzahlungsschutz.
...
(`remainingBalance`) der Rechnung nicht übersteigen. Diese Prüfung SHALL
innerhalb derselben gesperrten Transaktion erfolgen, die auch die
Zahlung anlegt, um eine Überzahlung durch nahezu gleichzeitige Zahlungen
zu verhindern.
...
#### Scenario: Zwei nahezu gleichzeitige Zahlungen, deren Summe den Gesamtbetrag übersteigt, führen zu genau einer Ablehnung
- **GIVEN** eine Rechnung mit einem Restbetrag, der kleiner ist als die
  Summe zweier nahezu gleichzeitig eingereichter Zahlungsbeträge
- **WHEN** beide Zahlungen nahezu gleichzeitig erfasst werden
- **THEN** genau eine Zahlung wird angelegt, die andere wird mit HTTP 422
  abgelehnt
