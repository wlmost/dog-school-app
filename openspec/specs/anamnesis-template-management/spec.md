...
Trainers create and maintain reusable anamnesis (intake questionnaire)
templates, each consisting of a set of questions. This capability covers
how templates and their questions are listed, displayed, and kept in sync
when a trainer creates or edits a template.
