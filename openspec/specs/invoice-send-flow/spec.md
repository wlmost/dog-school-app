...
Definiert den Versand einer freigegebenen Rechnung an den Kunden: einen
Dialog zur Wahl zwischen App-internem E-Mail-Versand (mit PDF-Anhang) und
manuellem Versand per PDF-Download, inklusive Berechtigungen und
Fehlerbehandlung bei fehlgeschlagenem Mailversand.
...
E-Mail-Adresse", YAGNI — die serverseitige Zustandsprüfung beim
tatsächlichen App-Mail-Versand bleibt als Defense-in-Depth bestehen,
siehe Requirement "App-interner E-Mail-Versand mit PDF-Anhang").
