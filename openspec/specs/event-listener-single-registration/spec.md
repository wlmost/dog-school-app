# event-listener-single-registration

## Purpose

Stellt sicher, dass jedes Domain-Event im Backend genau einen aktiven
Listener-Aufruf auslöst, um doppelte Nebenwirkungen (insbesondere
doppelten E-Mail-Versand) durch gleichzeitige manuelle Registrierung
und Laravels automatische Event-Discovery zu verhindern.
