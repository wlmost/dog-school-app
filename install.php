...
function configureHtaccess() {
    try {
        ...
        $rootContent = '<IfModule mod_rewrite.c>' . "\n"
            ...
            . '    RewriteRule ^$ /dog-school/ [R=301,L]' . "\n"
            . "\n"
            . '    # Strip Vite base path prefix (/dog-school/) - serve assets directly' . "\n"
            . '    RewriteRule ^dog-school/assets/(.+)$ frontend/dist/assets/$1 [L]' . "\n"
            . "\n"
            . '    # Strip Vite base path prefix (/dog-school/) - all other paths serve SPA' . "\n"
            . '    RewriteRule ^dog-school(/.*)?$ frontend/dist/index.html [L]' . "\n"
            . "\n"
            . '    # Serve existing static assets from frontend/dist/ (fallback)' . "\n"
